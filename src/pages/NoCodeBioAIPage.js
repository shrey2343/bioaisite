    ...
    <div className="nocode-page">
      ...
      <section className="cta-section">
        ...
        <div style={{position:'relative',zIndex:1,maxWidth:'680px',margin:'0 auto'}}>
          ...
          <h2 className="h2 fi" style={{marginBottom:'1.25rem'}}>Future-ready skills for <em style={{fontStyle:'italic',background:'var(--grad2)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',backgroundClip:'text'}}>bioinformatics, data science, and biotech.</em></h2>
