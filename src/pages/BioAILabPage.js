...
const heroBlobs = [
  { style: { width: 500, height: 500, top: '-60px', left: '-80px', background: '#86efac', opacity: 0.28 }, animate: { x: [0, 30, -10, 0], y: [0, -40, 20, 0] }, duration: 18 },
  { style: { width: 400, height: 400, top: '-40px', right: '-60px', background: '#4ade80', opacity: 0.18 }, animate: { x: [0, -25, 15, 0], y: [0, 30, -20, 0] }, duration: 22 },
  { style: { width: 350, height: 350, bottom: '-40px', left: '50%', transform: 'translateX(-50%)', background: '#bbf7d0', opacity: 0.38 }, animate: { x: [0, 20, -30, 0], y: [0, -20, 30, 0] }, duration: 15 },
  { style: { width: 300, height: 300, bottom: '-20px', left: '-40px', background: '#6ee7b7', opacity: 0.22 }, animate: { x: [0, -15, 25, 0], y: [0, 25, -15, 0] }, duration: 20 },
  { style: { width: 250, height: 250, top: '20px', left: '50%', transform: 'translateX(-50%)', background: '#a7f3d0', opacity: 0.32 }, animate: { x: [0, 20, -10, 0], y: [0, -30, 10, 0] }, duration: 25 },
];
...
/* Animated ticker bar */
const TICKER_ITEMS = [
  '8-Week Program', 'No-Code Tools', 'NGS Pipelines', 'Real Datasets',
  'GitHub Portfolio', 'Interview Ready', 'AI-Powered', 'Job in 90 Days',
  'Galaxy Platform', 'Biocon-Ready', 'Syngene-Ready', 'Indian Genomics',
];

function TickerBar() {
  const items = [...TICKER_ITEMS, ...TICKER_ITEMS]; // duplicate for seamless loop
  return (
    <div className="bioai-ticker-wrap">
      <div className="bioai-ticker-track">
        {items.map((item, i) => (
          <div key={i} className="bioai-ticker-item">
            <span className="bioai-ticker-dot" />
            {item}
          </div>
        ))}
      </div>
...
function SpotlightCard({ children, className, ...props }) {
  ...
  return (
    <motion.div ref={cardRef} className={className} onMouseMove={handleMouseMove} {...props}>
      {children}
    </motion.div>
  );
}
        ...
        <div className="bioai-hero-inner">
          ...
          <motion.div className="bioai-hero-actions fi"
            ...
            <motion.button onClick={openModal} className="btn btn-grad"
              whileHover={{ scale:1.04, boxShadow:'0 10px 32px rgba(27,67,50,0.35)' }}
              whileTap={{ scale:0.97 }}>
      ...
      <section className="bioai-section-dark">
        <div className="bioai-container fi">
          ...
          <div className="about-layout">
            ...
            {/* Enhanced NGS Pipeline */}
            <motion.div className="ngs-pipeline"
        ...
        <div className="bioai-container center fi">
          ...
          <StaggerSection className="bioai-glance-grid fi">
            {[
              ...
              <SpotlightCard key={i} className="bioai-glance-card" variants={fadeUp}
        ...
        <div className="bioai-container center fi">
          ...
          <StaggerSection className="bioai-bonus-grid fi">
            {[
              ...
              <motion.div key={idx} className="bioai-bonus-card" variants={scaleIn}
      ...
      <section className="bioai-section-light cta-section">
        ...
        <div className="bioai-container center fi">
          <div style={{ position:'relative', zIndex:1, maxWidth:'680px', margin:'0 auto' }}>
            <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
              viewport={{ once:true, margin:'-60px' }} transition={{ duration:0.6 }}>
              <div className="eyebrow fi" style={{ justifyContent:'center', display:'flex' }}>
                {'// Take the First Step'}
              </div>
              <h2 className="h2 fi" style={{ marginBottom:'1.25rem' }}>
                Ready to Start Your{' '}
              ...
              <p className="lead center fi" style={{ marginBottom:'3rem' }}>
            ...
            <motion.div className="cta-btns fi"
              ...
              <motion.button onClick={openModal} className="btn btn-grad"
                whileHover={{ scale:1.05, boxShadow:'0 12px 36px rgba(27,67,50,0.38)' }}
                whileTap={{ scale:0.97 }}>
                Get The Bioinformatics Interview Bible
              </motion.button>
            </motion.div>
