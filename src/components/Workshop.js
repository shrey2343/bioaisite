    ...
    <section id="workshop">
      <div className="sw">
        <div className="center">
          ...
          <h2 className="h2 fi" style={{marginBottom:'1rem'}}>Expert Guides to <span className="gt">Accelerate Your Success</span></h2>
          <p className="lead center fi" style={{marginBottom:'4rem'}}>Download our proven frameworks used by researchers worldwide</p>
        </div>

        <div className="resource-cards fi">
          {/* Card 1: Grant Winning Formula */}
          <div className="resource-card">
            <div className="resource-badge">FREE STRATEGY GUIDE</div>
            <h3 className="resource-title">The Grant Winning Formula</h3>
            <p className="resource-desc">The exact structure behind $18M+ in funded NIH, DBT & Wellcome Trust grants.</p>
            ...
            <button 
              onClick={() => openModal('/Grant_Winning_Formula_BioAI_Lab.pdf', 'The Grant Winning Formula')} 
          ...
          <div className="resource-card">
            ...
            <h3 className="resource-title">The PhD Rescue Checklist</h3>
            <p className="resource-desc">12 things every struggling PhD student should do before their next supervisor meeting.</p>
            ...
            <button 
              onClick={() => openModal('/PhD_Rescue_Checklist_BioAI_Lab (1).pdf', 'The PhD Rescue Checklist')} 
              className="btn btn-grad" 
              style={{width:'100%',justifyContent:'center'}}
            >
          ...
          <div className="resource-card">
            <div className="resource-badge">FREE DOWNLOAD</div>
            <h3 className="resource-title">The Bioinformatics Interview Bible</h3>
            <p className="resource-desc">20 real interview questions with model answers — written in simple English every biology student can understand.</p>
            ...
            <button 
              onClick={() => openModal('/Bioinformatics_Interview_Bible_Final.pdf', 'The Bioinformatics Interview Bible')} 
              className="btn btn-grad" 
              style={{width:'100%',justifyContent:'center'}}
            >
              Download Free Bible →
